...
class BYTETracker(object):
    def __init__(self, track_thresh=0.45, match_thresh=0.8, track_buffer=25, frame_rate=30):
        ...
        self.frame_id = 0
        self.track_buffer=track_buffer   # 30
        
        self.track_thresh = track_thresh   # 0.6
        self.match_thresh = match_thresh   # 0.8
        self.det_thresh = track_thresh + 0.1  # 0.7
        self.buffer_size = int(frame_rate / 30.0 * track_buffer)  # 30
        self.max_time_lost = self.buffer_size   # 30
